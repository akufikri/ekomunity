    ...
    <div id="forweb" class="card-custom" style="">
            ...
            <div style="width: 100%">
                @if ($data->instagram)
                    <a href="{{ $data->instagram }}" target="_blank">
                        <div class="fl ml-10"><img src="/images/digitalprofile/ig.png" width="40px" alt="Instagram">
                        </div>
                    </a>
                @endif
                @if ($data->facebook)
                    <a href="{{ $data->facebook }}" target="_blank">
                        <div class="fl ml-10"><img src="/images/digitalprofile/fb.png" width="40px" alt="Facebook">
                        </div>
                    </a>
                @endif
                @if ($data->tiktok)
                ...
                @if ($data->youtube)
                    <a href="{{ $data->youtube }}" target="_blank">
                        <div class="fl ml-10"><img src="/images/digitalprofile/yt.png" width="40px" alt="Youtube">
                        </div>
                    </a>
                @endif
            </div>
        ...
        <div class="fr sub-card">
            ...
            <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">
                {{ isset($data->user->fullname) ? $data->user->fullname : '-' }}</p>
            <div class="fl ml-10" style="float: right"><a target="_blank"
                    href="https://wa.me/{{ $data->phone_number }}"><img src="/images/digitalprofile/wa.png"
        ...
        <div class="fr sub-card">
            ...
            <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">
                {{ isset($data->phone_number) ? $data->phone_number : '-' }}</p>
            <div class="fl ml-10" style="float: right"><a target="_blank"
                    href="https://wa.me/{{ $data->phone_number }}"><img src="/images/digitalprofile/wa.png"
                        width="25px" alt="Whatsapp"></a></div>
        </div>
        ...
        <div class="fr sub-card">
            <div class="fl ml-10"><img src="/images/digitalprofile/person-group.png" width="30px" alt="Logo">
            </div>
        ...
        <div class="fr sub-card">
            <div class="fl ml-10"><img src="/images/digitalprofile/tabler-hierarchy.png" width="30px"
                    alt="Logo"></div>
            <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">Struktur Organisasi
            </p>
            <div class="fl ml-10" style="float: right"><a target="_blank"
                    href="/persatuan/structure/{{ $data->key_reference }}"><img
        ...
        @if ($auth == null)
            <div class="fr sub-card">
                <div class="fl ml-10"><img src="/images/digitalprofile/daftar-persatuan.png" width="30px"
                        alt="Logo"></div>
                <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">Daftar Sebagai
                    Ahli</p>
                <div class="fl ml-10" style="float: right"><a data-target="#authModal" data-toggle="modal"
                        href="#"><img src="/images/digitalprofile/right.png" width="20px"
        ...
        @elseif($auth->id_level == '3' || $auth->id_level == null)
            <div class="fr sub-card">
                ...
                <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">Daftar Sebagai
                    Ahli</p>
                <div class="fl ml-10" style="float: right"><a
                        href="/daftar_persatuan/{{ $data->key_reference }}"><img
                            src="/images/digitalprofile/right.png" width="20px" alt="Arrow Right"></a></div>
            </div>
        @endif
    ...
    <div id="formobile" class="card-custom" style="">
        ...
        <div style="text-align: center;">
            ...
            <div class="mt-20" style="width:300px">
                <p style="margin:0px; font-size:12px;color:gray;">{{ isset($data->address) ? $data->address : '-' }}
                </p>
            </div>
        </div>
        ...
        <div class="fr sub-card" style="margin-top: 20px;">
            ...
            <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">Jumlah Ahli</p>
            <div class="fl ml-10" style="float: right"><a target="_blank" href=""><img
                        src="/images/digitalprofile/right.png" width="25px" alt="Arrow Right"></a></div>
        </div>
            ...
            <form action="" method="POST" class="form-auth" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body my-table">
                        <h4 class="modal-title" id="exampleModalLabel"><b>Notis Ekomuniti</b></h4><br>
                        <h6 class="modal-title" id="exampleModalLabel">Jika anda pengguna pertama ekomuniti.</h6><br>
                        <a class="btn btn-md" style="color: darkred; background: #eae4e4;"
                            ...
                            Baru</a><br><br>
                        <h6 class="modal-title" id="exampleModalLabel">Jika anda sudah menjadi ahli ekomuniti.</h6>
                        <br>
            ...
            <form action="" method="POST" class="form-auth" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body my-table">
                        ...
                        <a class="btn btn-md btn-danger" href="/daftar_persatuan/{{ $data->key_reference }}">Saya
                            Bersetuju</a>
