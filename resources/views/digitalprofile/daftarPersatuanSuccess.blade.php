...
<body>
    ...
    <div id="forweb" class="card-custom" style="">
        ...
        <div class="fr" style="width: 100%;">
            ...
            <div class="fr" style="width:100%;">
                <p style="font-size: 25px; background: #DDFDD4; padding: 15px; border-radius: 15px;"><b>Permohonan Dihantar</b></p>
                <p style="margin:0px;font-size:18px;color:gray; float:left; text-align:justify; margin-left: 5px;">Sila tunggu, setiausaha persatuan akan membuat pengesahan pendaftaran persatuan anda.</p>
