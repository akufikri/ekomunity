    ...
    <div id="forweb" class="card-custom" style="">
        ...
        <div class="fr" style="width: 50%;">
            ...
            <div class="fr mt-20" style="width:100%;">
                ...
                <p style="margin:0px;width:300px;max-width:300px;font-size:12px;color:gray; float:left; text-align:justify;">Semak maklumat anda</p>

            </div>

            <div class="fr sub-card">
                <div class="fl ml-10"><img src="/images/digitalprofile/profile.png" width="25px" alt="Logo"></div>
                <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">{{ isset($user_auth->fullname) ? $user_auth->fullname : '-' }}</p>
            </div>

            <div class="fr sub-card">
                <div class="fl ml-10"><img src="/images/digitalprofile/email.png" width="25px" alt="Logo"></div>
                <p style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">{{ isset($user_auth->email) ? $user_auth->email : '-' }}</p>
            </div>

            <div class="fr sub-card">
                <div class="fl ml-10"><img src="/images/digitalprofile/id-card.png" width="30px" alt="Logo"></div>
                <p id="myText" style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">{{ isset($user_auth->manpower->ic_number) ? $user_auth->manpower->ic_number : '-' }}</p>
            </div>

            <div class="fr sub-card">
                <div class="fl ml-10"><img src="/images/digitalprofile/location-fill.png" width="30px" alt="Logo"></div>
                <p id="myText" style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left">{{ isset($user_auth->manpower->city->city) ? $user_auth->manpower->city->city : '-' }}</p>
            </div>

            <div class="fr sub-card-noborder">
                <p id="myText" style="margin-top:5px; margin-left:10px; font-size:14px; width:200px; float:left"><b>Yuran</b></p>
                <div class="fl ml-10" style="float: right"><b>{{ isset($data->joining_fee) ? 'RM'.$data->joining_fee.'/Tahun' : 'Free' }}</b></div>
            </div>

            <div class="fr sub-card-noborder">
                @if($join_company == null)
                    <a class="btn btn-md btn-danger" style="width: -webkit-fill-available; background: #b91c1c;" data-target="#tncModal" data-toggle="modal" href="#">Daftar</a>
                ...
                @else
                    <a class="btn btn-md btn-info" style="width: -webkit-fill-available;" href="#">Anda sudah terdaftar</a>
                @endif
            </div>
            ...
            <form action="" method="POST" class="form-auth" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body my-table">
                        <h6 class="modal-title" id="exampleModalLabel">Sila log masuk USIA terlebih dahulu sebelum mendaftar persatuan</h6><br>

                        <a class="btn btn-md btn-danger" href="/login">Log masuk</a>
                        <a class="btn btn-md" style="color: darkred;" href="/register_ahli/create">Pendaftaran Baharu</a>
            ...
            <form action="" method="POST" class="form-auth" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body my-table">
                        ...
                        <a class="btn btn-md btn-danger" href="/request_join_bypass_approval/{{$data->key_reference}}">Saya Bersetuju</a>
