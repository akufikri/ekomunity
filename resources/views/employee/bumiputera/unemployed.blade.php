...
@section('title','List Of Manpower Bumiputera Unemployed')

@section('breadcrumb')

<li class="breadcrumb-item active">List Of Manpower Bumiputera Unemployed</li>
    ...
    <div class="col-12">
        <div class="card card-primary card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title my-header text-primary">List Of Manpower Bumiputera Unemployed</h3>
            </div>
            <div class="card-body">
                <div class="row">
...
$(document).ready( function () {
    ...
    $('#datatable-crud').DataTable({
        ...
        scrollX: true,
        ajax: {
                url: "{{ route('employee.bumiputera.unemployed') }}",
                type: 'GET'
            },
        columns: [
