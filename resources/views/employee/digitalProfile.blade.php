    ...
    <div style="text-align: -webkit-center;">
        ...
        <div id="cardnew" class="cardnew" style="">
            <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                ...
                <div style="display: flex; align-items: center;">
                    <img class="img-circle"
                        src="{{ $data->user->photo ? '/Profil/' . $data->user->photo : asset('landingpage/images/logo/logo-ekomuniti.png') }}"
                ...
                <div style="width: 100%">
                    @if ($data->business_instagram)
                        <a href="{{ $data->business_instagram }}" target="_blank">
                            <div class="fl ml-10"><img src="/images/digitalprofile/ig.png" width="30px" alt="Instagram">
                            </div>
                        </a>
                    @endif
                    @if ($data->business_facebook)
                        <a href="{{ $data->business_facebook }}" target="_blank">
                            <div class="fl ml-10"><img src="/images/digitalprofile/fb.png" width="30px" alt="Facebook">
                            </div>
                        </a>
                    @endif
                    @if ($data->business_tiktok)
                        <a href="{{ $data->business_tiktok }}" target="_blank">
                            <div class="fl ml-10"><img src="/images/digitalprofile/tiktok.png" width="30px"
                                    alt="Tiktok"></div>
                        </a>
                    @endif
                    @if ($data->business_youtube)
                        <a href="{{ $data->business_youtube }}" target="_blank">
                            <div class="fl ml-10"><img src="/images/digitalprofile/yt.png" width="30px" alt="Youtube">
                            </div>
                        </a>
                    @endif
                </div>
            ...
            <div class="fr sub-cardnew">
                ...
                <p style="margin-top:5px; margin-left:10px; font-size:12px; width:200px; float:left">
                    {{ isset($data->user->phone_number) ? $data->user->phone_number : '-' }}</p>
                <div class="fl ml-10" style="float: right"><a target="_blank"
                        href="https://wa.me/{{ $data->user->phone_number }}"><img src="/images/digitalprofile/wa.png"
                            width="20px" alt="Whatsapp"></a></div>
            </div>

            <div class="fr sub-cardnew">
                <div class="fl ml-10"><img src="/images/digitalprofile/email.png" width="20px" alt="Logo"></div>
                <p id="myText" style="margin-top:5px; margin-left:12px; font-size:12px; width:200px; float:left">
                    {{ isset($data->user->email) ? $data->user->email : '-' }}</p>
                <div class="fl ml-10" style="float: right"><a onclick="copyContent()"><img
                            src="/images/digitalprofile/copy.png" width="20px" alt="Copy"></a></div>
            </div>
            ...
            <div class="fr sub-cardnew">
                ...
                <p style="margin-top:5px; margin-left:10px; font-size:12px; width:200px; float:left">Muat turun Profil Kod
                    QR</p>
                <div class="fl ml-10" style="float: right"><img src="/images/digitalprofile/download.png" width="20px"
                        alt="Download"></div>
            </div>
