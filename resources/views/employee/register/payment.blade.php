					...
					<div class="tab-content">
						<form action="" class="form-payment" method="GET" enctype="multipart/form-data">
                            ...
                            @if($setting_subscribe->price != "0")
                                <div class="text-right">
                                    <a href="/create_bill_subscribe_ahli?id={{$encrypt}}"><button style="width:100%" class="site-button button-md outline outline-2 btnku btn btn-xl d-block">Bayar via Payment Gateway</button></a>
                                </div>
                            @endif
                        <br>
