				...
				<div class="p-a30 border-1  max-w800 m-auto">
					<div class="tab-content">
						<form action="/" method="" enctype="multipart/form-data">
							...
							<h4 class="font-weight-700 titleku" style="text-align:center">Pembayaran Berjaya!</h4>
							<p class="font-weight-600" style="text-align:center">Tahniah! Pembayaran berjaya, Peroses akan disemak oleh pegawai terlebih dahulu</p>
							
							<div id="btnsubmitku" class="text-right">
						    	<button style="width:100%" class="site-button button-md outline outline-2 btnku btn btn-xl d-block" type="submit">Muat semula laman, Semak pembayaran</button>
							</div>
						</form>
					</div>
				</div>
