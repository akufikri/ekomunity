				...
				<div class="p-a30 border-1  max-w500 m-auto">
					<div class="tab-content">
						<form action="/semak_pendaftaran_result" method="GET" enctype="multipart/form-data">
                            @csrf
							<h4 class="font-weight-700 labelku">HASIL SEMAKAN</h4>

							<div class="p-a20 border-0  max-w500 m-auto text-left" style="background: #F1F4F8; border-radius: 12px;">
                                @if($data['level'] == "ahli")
                                <img src="/images/ic_account_datappk.png" style="float: left; margin-right: 10px;" alt="" width="50" height="50">
                                @else
                                <img src="/images/ic_account_no_datappk.png" style="float: left; margin-right: 10px;" alt="" width="50" height="50">
                                @endif
							    <p class="font-weight-700 labelku" style="margin: 0px;"><b>{{$data['no_kad']}}</b><br>{{$data['message']}}</p>
							</div>

							<br>
							<h4 class="font-weight-700 labelku">SEMAKAN KEMBALI</h4>
							...
							<div id="btnsubmitku" class="text-left">
								...
								<a href="/login"><input type="button" class="site-button button-md outline outline-2 btnku btn btn-md" value="LOGIN"></a>
							</div>
						</form>
					</div>
				</div>
