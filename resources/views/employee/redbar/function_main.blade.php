<?php 
                ...
                <!--MANPOWER-->
                @if(!$data_detail_manpower && $user->id_level === '3')
                    <p class="alert alert-danger" style="border-radius:0px">
                        * Please complete your <b>Personal Details</b> data  <a style="color: blue;" href="{{URL::to('personalDetail/'.Auth::user()->id)}}#view">here</a>
                    </p>
                @endif
                @if(!$data_employment_detail || !$data_employment_history && $user->id_level === '3')
                    <p class="alert alert-danger" style="border-radius:0px">
                        * Please provide your <b>Employment Details</b> data  <a style="color: blue;" href="{{URL::to('employmentDetail/'.Auth::user()->id)}}#view">here</a>
                    </p>
                @endif
                
                @if(!$data_summary_qualification && $user->id_level === '3')
                    <p class="alert alert-danger" style="border-radius:0px">
                        * Please fill your <b>Summary Qualification</b> data  <a style="color: blue;" href="{{URL::to('/summaryQualification')}}#view">here</a>
                    </p>
                @endif
                <!--@if(!$data_other_qualification && $user->id_level === '3')-->
                <!--    <p class="alert alert-danger" style="border-radius:0px">-->
                <!--        5. Please complete your <b>Other Qualification</b> data  <a style="color: blue;" href="{{URL::to('/otherQualification')}}#view">here</a>-->
                <!--    </p>-->
                <!--@endif-->