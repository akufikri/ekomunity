				...
				<div class="p-a30 border-1  max-w500 m-auto">
					<div class="tab-content">
						<form action="{{ route('company.store') }}" method="POST" enctype="multipart/form-data">
							...
							<p class="font-weight-600">Sudah mempunyai akaun? <a href="{{ route('login') }}"><b style="color: #383444;"> Log Masuk Sekarang</b></a></p>

							<div class="form-group">
								<label class="font-weight-700 labelku">Nama Wakil <span style="color: #383444;" >*</span> </label>
							...
							<div class="form-group">
								<label class="font-weight-700 labelku">Nama Cawangan <span style="color: #383444;" >*</span> </label>
								<input id="nama_pertubuhan" type="text" class="form-control-lg form-control @error('nama_pertubuhan') is-invalid @enderror" name="nama_pertubuhan" value="{{ old('nama_pertubuhan') }}" placeholder="Nama Persatuan" required autocomplete="nama_pertubuhan" autofocus>
							...
							<div class="form-group">
								<label class="font-weight-700 labelku">Emel Wakil <span style="color: #383444;" >*</span> </label>
                            ...
                            <div class="form-group">
							    <label class="font-weight-700 labelku">No. Telefon Wakil<span style="color: #383444;" >*</span> </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 pl-0">
                                        <input id="phone_number" style="padding-top: 12px !important; margin-top: 12px !important;" type="number" class="form-control-lg form-control @error('phone_number') is-invalid @enderror" name="phone_number" placeholder ="No. Telefon Wakil" required>
							...
							<div class="form-group">
								<label class="font-weight-700 labelku">Kata Laluan <span style="color: #383444;" >*</span> </label>
							...
							<div class="form-group">
								<label class="font-weight-700 labelku">Sahkan Kata Laluan <span style="color: #383444;" >*</span> </label>
