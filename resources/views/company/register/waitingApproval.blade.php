					...
					<div class="tab-content">
						<form action="/" method="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3" style="text-align:center">
								    <img id="image" src="/images/payment_success.png" width="100px" alt="Upload Image">
							</div>
							<h4 class="font-weight-700 titleku" style="text-align:center">Pendaftaran Anda Sedang Diproses</h4>
							<p class="font-weight-600" style="text-align:center">Tahniah! Borang pendaftaran anda berjaya dihantar! Maklumat anda sedang disemak oleh pegawai G3PNS</p>
							
							<div id="btnsubmitku" class="text-right">
						    	<button style="width:100%" class="site-button button-md outline outline-2 btnku btn btn-xl d-block" type="submit">Reload, Check Approval</button>
							</div>
						</form>
					</div>
				</div>
