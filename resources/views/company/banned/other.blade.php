...
@section('title','List Of Company Ban Other')

@section('breadcrumb')

<li class="breadcrumb-item active">List Of Company Ban Other</li>
    ...
    <div class="col-12">
        <div class="card card-primary card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title text-primary my-header">List Of Company Ban Other</h3>
            </div>
            <div class="card-body">
                <div class="row">
...
$(document).ready( function () {
    ...
    $('#datatable-crud').DataTable({
        ...
        scrollX: true,
        ajax: {
                url: "{{ route('company.banned.other') }}",
                type: 'GET'
            },
        columns: [
