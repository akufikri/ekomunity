...
<li class="breadcrumb-item active"><a>List of Key Client & Project</a></li>
@endsection
...
@include('company.redbar.function_project_experiences') 
<div class="row" id="view">
    <div class="col-12">
        <div class="card card-primary card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title text-primary my-header">Key Client & Project</h3>
    ...
    <div class="col-12">
        <div class="card card-primary card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{URL::to('clearRequestUpdateCompany/KEY_CLIENT')}}#view" title="Cancel Update" class="btn btn-sm btn-danger" >Cancel Update</a>
                </div>
            </div>
            <div class="card-body my-table">
                <div class="row">
...
<div class="modal fade" id="addProject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form action="{{URL::to('/createKeyClientProject')}}" class="form-add-data" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Key Client & Project</h5>
            ...
            <div class="modal-body my-table">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="project_value" name="project_value" placeholder="Project Value" step=".01" required>
                </div>
                <div class="form-group">
                    <label for="Letter offer">Letter offer</label>
                    <input type="file" name="offer_later[]" accept=".doc,.docx,.txt,.pdf" class="form-control" required>
                </div>
            </div>
...
<script type="text/javascript">
        ...
        columnDefs: [
                {
                    ...
                    "render" : function (data, type, row) {//class="btn btn-primary btn-sm"
                        ...
                        '<a href="/companyKeyClientProject/'+row.id_company_project+'/edit" title="Edit" class="btn btn-warning btn-sm"><i class="fas fa-user-edit"></i></button></a>'+
    ...
    $('#datatable-crud-temp').DataTable({
        ...
        scrollX: true,
        ajax: {
                url: "/companyKeyClientProjectTemp#view",
                type: 'GET'
            },
        columns: [
            { data: 'DT_RowIndex' },
    ...
    $("body").on("click","#deleteData",function(e){
            ...
            $.ajax(
            {
                url: "/companyKeyClientProject/"+id, 
                type: 'DELETE',
                data: {
                    _token: token,
                        id: id
                ...
                success: function (response){
                    ...
                    loadData()
                    loadDataTemp()
                    location.href = "companyKeyClientProject"
                    swal(
                        'Success!',
    ...
    $("body").on("click","#deleteDataTemp",function(e){
            ...
            $.ajax(
            {
                url: "/deleteTempCompanyKeyClientProject/"+id+'#view', 
                type: 'DELETE',
                data: {
                    _token: token,
                        id: id
