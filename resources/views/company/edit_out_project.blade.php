...
@section('title','List of Out Source Project')

@section('breadcrumb')
<? $user = Auth::user()->id; ?>
<li class="breadcrumb-item active"><a href="/companyOutSourceProject">List of Out Source Project</a></li>
...
<div class="card card-primary card-outline" style="border-top: 3px solid dark">
    <div class="card-header">
        <h3 class="card-title my-header text-primary">Edit List of Out Source Project</h3>
    </div>
    <div class="card-body">
        <form action="{{URL::to('companyOutSourceProject/update/'.$data->id_company_project.'')}}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="clone hide">
                                    ...
                                    <a href="{{ asset('CompanyProject/'.$ofer.'') }}" target="_blank">Open the pdf!</a>
                                </div>
                                <br>
                                @endforeach
                            </div>
            ...
            <div class="card-footer">
                <a href="/companyOutSourceProject" class="btn btn-sm btn-dark">Back</a>	
