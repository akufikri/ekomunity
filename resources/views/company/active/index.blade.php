...
@section('title','List Of Company Active')

@section('breadcrumb')

<li class="breadcrumb-item active">List Of Company Active</li>
    ...
    <div class="col-12">
        <div class="card card-danger card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title my-header text-danger">Senarai Persatuan</h3>
            </div>
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm nowrap" id="datatable-crud">
                                <thead>
                                    <tr>
                                        <th width="5%">No</th>
                                        <th>Logo Persatuan</th>
                                        <th>Nama Persatuan</th>
                                        <th>No. Telefon Persatuan</th>
                                        <th>Emel Persatuan</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
        ...
        columnDefs: [
                {
                    ...
                    "render" : function (data, type, row) {//class="btn btn-primary btn-sm"
                        ...
                        '<a href="/detailCompanyAdmin/'+row.id_user+'" class="btn btn-info btn-sm"><i class="fa fa-info-circle nav-icon"></i></a>'+
                        '<a href="/certifikat_company/'+row.id_user+'" class="btn btn-success btn-sm"><i class="fas fa-certificate"></i></i></a>'
