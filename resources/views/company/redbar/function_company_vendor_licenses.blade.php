<?php 
    ...
    @if($certificate_waiting && $user->id_level == '2')
                ...
                @if(!$company_approve && $data_detail_company && $data_auth_paid_up_capital && $data_shareholders && $data_segment && $data_project && $data_swec_code && $data_workers && $vendor_licenses && $user->id_level == '2')
                    <p class="alert alert-warning" style="border-radius:0px">
                ...
                @if($vendor_licenses && $user->id_level == '2')
                    <p class="alert alert-danger" style="border-radius:0px">
                          List your registered company Vendor Licenses data <b>below.</b>
                    </p>
                @endif