...
<input id="data" type="hidden" value="{{$village_guests}}">
 
<script>
	mapboxgl.accessToken = 'pk.eyJ1IjoicmlkZXJ1bm5lcm15IiwiYSI6ImNrOHptdGloeTE3NXIzc213aXEybDRkY2UifQ.5a1AaVjCXWW36GJ9TLjLKg';
...
var dataCustom = JSON.parse(document.getElementById("data").value);

// console.log("data lat: "+dataCustom[0].lat+" ,lng: "+dataCustom[0].lng);


dataCustom.forEach(myFunction)
...
const popupContent = `
    <div style="display: flex; flex-direction: row; gap: 10px;">
        ...
        <div class="card" style="padding:10px; border:1px solid #ccc; border-radius:8px; width: 200px;">
            Nama Daerah:<br>
            <strong>${item.village_guests}</strong><br>
...
`;
    ...
    var popup = new mapboxgl.Popup({ offset: 20, maxWidth: "800px" })
