...
function loadData(){
    ...
    $('#datatable-crud').DataTable({
        ...
        scrollX: true,
        ajax: {
                url: "/log_pembayaran_ahli"+queryString,
                type: 'GET'
            },
        columns: [
            { data: 'DT_RowIndex' },
            ...
            { data: 'approval_date' },
            { data: 'payment_type' },
            { data: 'id', visible: id == '3' ? false : true, className: 'text-center' },
        ],
        columnDefs: [
                {
                    "targets" : 5,
                ...
                // },
                {
                    ...
                    "render" : function (data, type, row) {//class="btn btn-primary btn-sm"
                        if(row.approval == "WAITING") {    
                            return btn = '<a href="" id="detailApproval" data-id="'+row.id+'"  data-toggle="modal" data-target="#detailApprovalModal" class="btn btn-info btn-sm" >Respon</a>'
                        } else {
                            return '-'
                        }
                    }
