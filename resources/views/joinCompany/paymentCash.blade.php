    ...
    <div class="container">
        <div class="row">
			<div class="col-md-12 text-center">
				<h3 class="font-weight-700 m-t0 m-b20 titleku">Pembayaran Join Persatuan </h3>
			...
			<div class="col-md-12 m-b30">
				<div class="p-a30 border-1  max-w800 m-auto">
					<div class="tab-content">
						<form action="/create_payment" method="POST" enctype="multipart/form-data">
                            @csrf
							...
							<p class="font-weight-600"><i>Pembayaran akan dilakukan pengecekan oleh Admin Persatuan, selama waktu tersebut akun anda akan ditangguhkan</i></p>
