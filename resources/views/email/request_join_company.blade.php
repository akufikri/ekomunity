...
<body>
    <div style="background: #fbfbfb;">
        ...
        <div style="padding:1%;text-align:center;background: #4190f2;">
            <div style="color:#fff;font-size:20px;font-weight:500;">Notis Datappk</div>
        </div>
        
        <div style="max-width:560px;margin:auto;padding: 0 3%;">
            <div style="padding: 30px 0; color: #555;line-height: 1.7;">
                
                <p>Ada permohonan mendaftar di Persatuan {{$company}} oleh {{$manpower}}. Sila tekan butang dibawah untuk sahkan pendaftaran.</p>
                <br>
            </div>
            <br>
