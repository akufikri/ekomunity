...
<head>
    ...
    <meta name="description"
        content="Unit Saudara Islam (USIA) Sabah - Organisasi dakwah Islam terkemuka di Sabah. Menyediakan program pembangunan ummah, pendidikan Islam, bantuan mualaf, dan khidmat sosial untuk masyarakat Islam di seluruh Sabah.">
    <meta name="keywords"
        content="USIA, Unit Saudara Islam, Islam Sabah, dakwah Sabah, mualaf Sabah, pendidikan Islam, bantuan kebajikan Islam, organisasi Islam Sabah, khidmat sosial Islam, pembangunan ummah Sabah">
    ...
    <meta property="og:description"
        content="Unit Saudara Islam (USIA) Sabah - Organisasi dakwah Islam terkemuka di Sabah. Menyediakan program pembangunan ummah, pendidikan Islam, bantuan mualaf, dan khidmat sosial.">
    ...
    <meta property="twitter:description"
        content="Unit Saudara Islam (USIA) Sabah - Organisasi dakwah Islam terkemuka di Sabah. Menyediakan program pembangunan ummah, pendidikan Islam, dan khidmat sosial.">
    ...
    @else
        <link href="{{ asset('landingpage/images/logo/logo-ekomuniti.png') }}" rel="icon">
    @endif
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Noto+Sans:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
