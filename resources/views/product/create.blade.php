...
@section('content')
    ...
    <div class="card card-danger card-outline" style="border-top: 3px solid dark">
        ...
        <div class="card-body">
            <form action="/maklumatProduk/store" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="product_category" class="form-control form-control-lg1" required autofocus>
                                <option disabled value="" selected>Pilih Kategori Produk</option>
                                @foreach ($categoryProduct as $d)
                                    <option value="{{ $d->id_category_product }}">{{ $d->category_product }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="product_description" rows="3" cols="50"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" style="justify-content: center;">
                        ...
                        {{-- <a class="btn btn-md btn-danger col-md-6"  style="padding: 10px;margin: 0px;float: left;"
                            href="">Simpan</a><br><br> --}}
                        <input type="submit" id="" value="Simpan" style="padding: 10px;margin: 0px;float: left;" class="btn btn-md btn-danger col-md-6"><br><br>
