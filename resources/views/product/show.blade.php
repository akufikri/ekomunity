                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$product->product_name}}" class="form-control form-control-lg" placeholder=""
                                name="product_name" required autofocus readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="product_category" class="form-control form-control-lg1" required autofocus disabled>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="product_description" rows="3" cols="50" readonly>{{$product->product_description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" style="justify-content: center;">
                        <a class="btn btn-md col-md-6"
                            style="padding: 10px;margin-right: 0px;color: darkred;background: #f1f1f1;float: left;"
                            href="/maklumatProduk">Kembali</a>
                        <a class="btn btn-md btn-danger col-md-6"  style="padding: 10px;margin: 0px;float: left;"
                            href="/maklumatProduk/edit/{{ $product->id }}">Edit</a><br><br>
                
                        {{-- <input type="button" id="" value="Edit" style="padding: 10px;margin: 0px;float: left;" class="btn btn-md btn-danger col-md-6"><br><br> --}}
