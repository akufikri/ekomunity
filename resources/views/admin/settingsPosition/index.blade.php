...
<li class="breadcrumb-item active"><a>Jawatan</a></li>
@endsection
    ...
    <div class="col-12">
        <div class="card card-danger card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title text-danger my-header">Jawatan</h3>
...
<!--ADD POSITION-->
        <div class="modal fade" id="addPosition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="/create_position" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add Jawatan</h5>
                    ...
                    <div class="modal-body my-table">
                        <!-------->
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="position" name="position" placeholder="Jawatan" required>
                          </div>
                          <div class="form-group">
...
<!--UPDATE POSITION-->
        <div class="modal fade" id="updatePosition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="" class="form-update-data" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Update Jawatan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
<!--DETAIL POSITION-->
        <div class="modal fade" id="detailPosition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="" class="form-update-data" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Detail Jawatan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
$(document).ready( function () {
    ...
    $('#datatable-crud').DataTable({
        ...
        columnDefs: [
                ...
                },
                {
                    ...
                    "data": "c",
                    "render" : function (data, type, row) {//class="btn btn-primary btn-sm"
                        var btn = '<a href="#" id="detailData" data-toggle="modal" data-target="#detailPosition" data-id="'+row.id_position+'" class="btn btn-primary btn-sm"><i class="fa fa-info-circle nav-icon"></i></a> '+
                        '<a href="#" id="editData" data-id="'+row.id_position+'"  data-toggle="modal" data-target="#updatePosition" class="btn btn-warning btn-sm"><i class="fa fa-edit nav-icon"></i></a>'
                        // '<a href="" id="deleteData" data-id="'+row.id_position+'" class="btn btn-danger btn-sm"><i class="fa fa-trash nav-icon"></i></a>'
                        return btn; //settings_position/'+row.id_position+'/edit
                    }
                },
    ...
    $("body").on("click","#editData",function(e){
            ...
            $.ajax(
            {
                url: "/settings_position/"+id+"/edit", //settings_position/'+row.id_position+'/edit
                type: 'GET',
                data: {
                    _token: token,
                        id: id
                ...
                success: function (response){
                    ...
                    if (response.data != null) {
                        ...
                        form.find('input[name=id]').val(data.id_position);
