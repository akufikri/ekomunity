...
<li class="breadcrumb-item active"><a>Jantina</a></li>
@endsection
    ...
    <div class="col-12">
        <div class="card card-danger card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title text-danger my-header">Jantina</h3>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="/create_gender" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Jantina</h5>
                ...
                <div class="modal-body my-table">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="gender" name="gender" placeholder="Jantina" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="" method="POST" class="form-update-data" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update Jantina</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body my-table">
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="id_gender" name="id_gender" placeholder="Jantina" required>
                        <label for="#">Jantina</label>
                        <input type="text" class="form-control" id="gender" name="gender" placeholder="Jantina" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="" method="POST" class="form-update-data" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Jantina</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body my-table">
                    <div class="form-group">
                        <label for="#">Jantina</label>
                        <input type="text" class="form-control" id="gender" name="gender" placeholder="Jantina" readonly>
                    </div>
                    <div class="form-group">
                        <label for="#">Description</label>
...
<script type="text/javascript">
            ...
            columnDefs: [
                ...
                },
                {
                   ...
                   "render": function(data, type, row){
                       var btn = '<a href="#" id="detailData" data-id="'+row.id_gender+'" data-toggle="modal" data-target="#detailModal" class="btn btn-primary btn-sm"><i class="fa fa-info-circle nav-icon"></i></a> '+
                       '<a href="#" data-toggle="modal" id="editData" data-id="'+row.id_gender+'" data-target="#updateModal" class="btn btn-warning btn-sm"><i class="fa fa-edit nav-icon"></i></a>'
            ...
            $.ajax(
            {
                ...
                success: function (response){
                    ...
                    if (response.data != null) {
                        ...
                        form.find('input[name=id_gender]').val(data.id_gender);
    ...
    $(document).on('submit', '.form-update-data', function(e){
            ...
            var ini = $(this),  input_token = $('input[name=_token]'),
                id = ini.find('input[name=id_gender]').val(),
                url = '/update_gender/'+id;
            var post_data = {
                is_ajax: true,
                _token: input_token.val(),
                gender: ini.find('input[name=gender]').val(),
