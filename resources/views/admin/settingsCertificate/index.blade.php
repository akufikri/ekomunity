                ...
                <div class="modal-body my-table">
                    ...
                    <div id="EditArticleModalBody">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="id_settings_certificate" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="valid_time" id="editValidTime" readonly required>                     
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body my-table">
                    ...
                    <div id="ShowCertificateModalBody">
                        ...
                        <div class="form-group">
                            <label for="Sign Name">Sign Name:</label>
                            <input type="text" class="form-control" name="sign_name" id="editSignName" disabled>
                        </div>
                        <div class="form-group">
                            <label for="Sign Position">Sign Position:</label>
                            <input type="text" class="form-control" name="sign_position" id="editSignPosition" disabled>                     
                        </div>
                        <div class="form-group">
                            <label for="Valid Time">Valid Time:</label>
                            <input type="text" class="form-control" name="valid_time" id="editValidTime" disabled>                     
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script type="text/javascript" src="js/page/admin/settingsCertificate/index.js"></script>
