...
<li class="breadcrumb-item active">Request Data Update</li>
    ...
    <div class="col-12">
        <div class="card card-danger card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title my-header text-danger">Request Update Data</h3>
            </div>
            <div class="card-body">
                <div class="row">
...
$(document).ready( function () {
    ...
    $('#datatable-crud').DataTable({
        ...
        scrollX: true,
        ajax: {
                url: "/requestUpdateCompany"+queryString,
                type: 'GET'
            },
        ...
        columnDefs: [
                {
                    ...
                    "render" : function (data, type, row) {//class="btn btn-primary btn-sm"
                        var btn = //'<a href="/learn/detail/'+row.id_company_project+'" data-toggle="modal" data-target="#addProject" class="btn btn-primary btn-sm"><i class="fa fa-info-circle nav-icon"></i></a>'+
                         '<a href="/detailRequestUpdateCompany/'+row.id_request_update+'" class="btn btn-primary btn-sm" style="font-family:arial; font-size:14px;"><i class="fa fa-info-circle nav-icon"></i>&nbsp;&nbsp;DETAIL</a>'
