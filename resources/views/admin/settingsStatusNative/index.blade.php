...
<li class="breadcrumb-item active"><a>Status Bumiputera</a></li>
@endsection
    ...
    <div class="col-12">
        <div class="card card-danger card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title text-danger my-header">Status Bumiputera</h3>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="/create_status_native" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Status Bumiputera</h5>
                ...
                <div class="modal-body my-table">
                    ...
                    <div class="form-group">
                        <label for="#">Status Bumiputera</label>
                        <input type="text" class="form-control" id="status_native" name="status_native" placeholder="Status Bumiputera" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="" method="POST" class="form-update-data" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update Status Bumiputera</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body my-table">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="id_status_native" name="id_status_native" placeholder="Status Bumiputera" required>
                        <label for="#">Status Bumiputera</label>
                        <input type="text" class="form-control" id="status_native" name="status_native" placeholder="Status Bumiputera" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="" method="POST" class="form-update-data" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Status Bumiputera</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body my-table">
                    ...
                    <div class="form-group">
                        <label for="#">Status Bumiputera</label>
                        <input type="text" class="form-control" id="status_native" name="status_native" placeholder="Status Bumiputera" readonly>
                    </div>
                    <div class="form-group">
                        <label for="#">Description</label>
...
<script type="text/javascript">
    ...
    function loadData(){
        $('#datatable-crud').DataTable({
            ...
            scrollX: true,
            ajax:{
                url: "/list_settings_status_native",
                type: 'GET'
            },
            columns: [
                { data: 'DT_RowIndex'},
                ...
                { data: 'is_active'},
                { data: 'create_date'},
                { data: 'id_status_native', className: 'text-center'},
            ],
            columnDefs: [
                {
                    "targets" : 3,
                ...
                {
                   "targets": 5,
                   "data": "id_status_native",
                   "render": function(data, type, row){
                       var btn = '<a href="#" id="detailModal" data-id="'+row.id_status_native+'" data-toggle="modal" data-target="#detailModal" class="btn btn-primary btn-sm"><i class="fa fa-info-circle nav-icon"></i></a> '+
                       '<a href="#" data-toggle="modal" id="editData" data-id="'+row.id_status_native+'" data-target="#updateModal" class="btn btn-warning btn-sm"><i class="fa fa-edit nav-icon"></i></a>'
    ...
    $("body").on("click","#editData",function(e){
            ...
            $.ajax(
            {
                url: "/settings_status_native/"+id+"/edit",
                type: 'GET',
                data: {
                    _token: token,
                        id: id
                ...
                success: function (response){
                    ...
                    if (response.data != null) {
                        ...
                        form.find('input[name=id_status_native]').val(data.id_status_native);
                        form.find('input[name=status_native]').val(data.status_native);
    ...
    $(document).on('submit', '.form-update-data', function(e){
            ...
            var ini = $(this),  input_token = $('input[name=_token]'),
                id = ini.find('input[name=id_status_native]').val(),
                url = '/update_status_native/'+id;
            var post_data = {
                is_ajax: true,
                _token: input_token.val(),
                status_native: ini.find('input[name=status_native]').val(),
            ...
            .done(function (result) {
                ...
                if (result.data != null) {
                    ...
                    swal(
                        'Success!',
                        'Update Status Bumiputera Successfully!',
                        'success'
                    )
