    ...
    <div id="forweb" class="card-custom" style="">
        ...
        <div class="fr" style="width: 100%;">
            ...
            <div class="fr" style="width:100%;">
                ...
                <p style="margin:0px;font-size:18px;color:gray; float:left; text-align:justify; margin-left: 5px;">Sila tunggu, admin akan membuat pengesahan Pembayaran anda.</p>
