...
@section('breadcrumb')
    <li class="breadcrumb-item active">Other Qualification</li>
@endsection
    ...
    <div class="col-12">
        <div class="card card-primary card-outline" style="border-top: 3px solid dark">
            <div class="card-header">
                <h3 class="card-title text-primary my-header">Other Qualification</h3>
                <div class="card-tools">
                    <a href="{{URL::to('/otherQualification/create')}}"  class="btn btn-sm btn-success pull-right">
        ...
        $('#datatable-crud').DataTable({
            ...
            "columnDefs" : [
                    ...
                    },
                    {
                        ...
                        "data": "Actions",
                        "render" : function (data, type, row) {
                            // '<button type="button" class="btn btn-info btn-sm" id="getShowData3" title="Detail" data-id="'+row.id_other_qualification+'"><i class="fas fa-info-circle"></i></i></button>'+
                                 return '<a href="/otherQualification/'+row.id_other_qualification+'/edit" title="Edit" class="btn btn-warning btn-sm"><i class="fas fa-user-edit"></i></button></a>'+
                                  '<button type="button" data-id="'+row.id_other_qualification+'" title="Delete" class="btn btn-danger btn-sm" id="getDeleteId"><i class="fas fa-trash"></i></button>';
                        }
                    }
                ],
            order: [[0, 'asc']]
