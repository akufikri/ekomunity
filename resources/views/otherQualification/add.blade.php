...
<div class="card">
    <div class="card-header">
        <h3 class="card-title my-header text-primary">Add Other Qualification</h3>
    </div>
    <div class="card-body">
        <form action="{{ route('otherQualification.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-9">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="organizer" class="form-control" placeholder="Institute/University" required autofocus>
								@error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="qualification" class="form-control" placeholder="Qualification" required autofocus>
								@error('name')
								<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
								@enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" name="other_date" class="form-control" placeholder="Date" required autofocus>
								@error('name')
								<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
								@enderror
                            </div>
